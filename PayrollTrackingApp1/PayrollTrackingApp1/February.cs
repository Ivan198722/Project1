...
{
    public partial class February : Form
    {
        DataBase dB = new DataBase();
        public February()
        {
            InitializeComponent(); dataGridView1.Columns[0].Width = 40;
            ...
            dataGridView1.Columns[59].Width = 55;
        }
        ...
        class Salary : SalaryCalculator
        {
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.February_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = from month in _dbEntities.February_2023
                            where month.Id == id
                            select new
                            {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            string totalSalary = dataGridView1.Rows[rowIndex].Cells[59].Value.ToString();

            try
            {
                // Wykonaj zapytanie do bazy danych
                string query = "UPDATE February_2023 SET [1]=" + day1 + ",[1DailiSalary]=" +salary.WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + salary.WorkDaySalary(day2, id) + "," +
                    ...
                    "[27]=" + day27 + ",[27DailiSalary]=" + salary.WorkDaySalary(day27, id) + ",[28]=" + day28 + ",[28DailiSalary]=" + salary.WorkDaySalary(day28, id) + "  WHERE Id = " + id;
            ...
            try
            {
                string query1 = "UPDATE February_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
