...
namespace PayrollTrackingApp1
{
    public partial class January : Form
    {
        ...
        private void January_Load(object sender, EventArgs e)
        {
            ...
            this.january_2023TableAdapter.Fill(this.payrollTrackingDBDataSet9.January_2023);
            this.WindowState = FormWindowState.Maximized;
        }

        class Salary : SalaryCalculator
        {
            // Przesłonięta metoda do pobierania danych dla zwykłego dnia pracy
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.January_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            // Przesłonięta metoda do pobierania danych dla weekendu
            ...
            // Przesłonięta metoda do pobierania danych dla całego miesiąca
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                var query = from month in _dbEntities.January_2023
                            where month.Id == id
                            select new
                            {
        ...
        // Utworzenie instancji klasy Salary
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            string totalSalary = dataGridView1.Rows[rowIndex].Cells[65].Value.ToString();
                ...
                string query = "UPDATE January_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + salary.WeekendDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" +salary. WorkDaySalary(day2, id) + "," +
                        ...
                        "[6]=" + day6 + ",[6DailiSalary]=" + salary.WeekendDaySalary(day6, id) + ",[7]="+day7+",[7DailiSalary]=" + salary.WeekendDaySalary(day7, id) + ",[8]="+day8+",[8DailiSalary]=" + salary.WeekendDaySalary(day8, id) + "," +
                        ...
                        "[12]=" + day12 + ",[12DailiSalary]=" + salary.WorkDaySalary(day12, id) + ",[13]=" + day13 + ",[13DailiSalary]=" + salary.WorkDaySalary(day13, id) + ",[14]=" + day14 + ",[14DailiSalary]=" + salary.WeekendDaySalary(day14, id) + "," +
                        "[15]=" + day15 + ",[15DailiSalary]=" + salary.WeekendDaySalary(day15, id) + ",[16]=" + day16 + ",[16DailiSalary]=" + salary.WorkDaySalary(day16, id) + ",[17]=" + day17 + ",[17DailiSalary]=" + salary.WorkDaySalary(day17, id) + "," +
                        ...
                        "[21]=" + day21 + ",[21DailiSalary]=" + salary.WeekendDaySalary(day21, id) + ",[22]=" + day22 + ",[22DailiSalary]=" + salary.WeekendDaySalary(day22, id) + ",[23]=" + day23 + ",[23DailiSalary]=" + salary.WorkDaySalary(day23, id) + "," +
                        ...
                        "[27]=" + day27 + ",[27DailiSalary]=" + salary.WorkDaySalary(day27, id) + ",[28]=" + day28 + ",[28DailiSalary]=" + salary.WeekendDaySalary(day28, id) + ",[29]=" + day29 + ",[29DailiSalary]=" + salary.WeekendDaySalary(day29, id) + "," +
            ...
            try
            { 
                string query1 = "UPDATE January_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
