    ...
    public partial class April : Form
    {
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.April_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.April_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.April_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE April_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WeekendDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WeekendDaySalary(day2, id) + "," +
                    ...
                    "[30]=" + day27 + ",[30DailiSalary]=" + WorkDaySalary(day30, id) + " WHERE Id = " + id;
            ...
            try
            {
                string query1 = "UPDATE April_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
