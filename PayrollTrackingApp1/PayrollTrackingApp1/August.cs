...
namespace PayrollTrackingApp1
{
    public partial class August : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "payrollTrackingDBDataSet11.August_2023". При необходимости она может быть перемещена или удалена.
            this.august_2023TableAdapter.Fill(this.payrollTrackingDBDataSet11.August_2023);
        ...
        class Salary : SalaryCalculator
        {
            ...
            {
                var query = base.GetSalaryData(id);
            ...
            {
                var query = base.GetSalaryData_Weekend(id);
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = base.GetSalaryData_Month(id);
                return query;
            }
        }
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE August_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + salary.WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + salary.WorkDaySalary(day2, id) + "," +
                    "[3]=" + day3 + ",[3DailiSalary]=" + salary.WorkDaySalary(day3, id) + ",[4]=" + day4 + ",[4DailiSalary]=" + salary.WorkDaySalary(day4, id) + ",[5]=" + day5 + ",[5DailiSalary]=" +salary.WeekendDaySalary(day5, id) + "," +
                    "[6]=" + day6 + ",[6DailiSalary]=" + salary.WeekendDaySalary(day6, id) + ",[7]= "+day7+",[7DailiSalary]=" + salary.WorkDaySalary(day7, id) + ",[8]="+day8+",[8DailiSalary]=" + salary.WorkDaySalary(day8, id) + "," +
                    "[9]=" + day9 + ",[9DailiSalary]=" + salary.WorkDaySalary(day9, id) + ",[10]=" + day10 + ",[10DailiSalary]=" + salary.WorkDaySalary(day10, id) + ",[11]=" + day11 + ",[11DailiSalary]=" + salary.WorkDaySalary(day11, id) + "," +
                    "[12]=" + day12 + ",[12DailiSalary]=" + salary.WeekendDaySalary(day12, id) + ",[13]=" + day13 + ",[13DailiSalary]=" + salary.WeekendDaySalary(day13, id) + ",[14]=" + day14 + ",[14DailiSalary]=" + salary.WorkDaySalary(day14, id) + "," +
                    ...
                    "[18]=" + day18 + ",[18DailiSalary]=" + salary.WorkDaySalary(day18, id) + ",[19]=" + day19 + ",[19DailiSalary]=" + salary.WeekendDaySalary(day19, id) + ",[20]=" + day20 + ",[20DailiSalary]=" + salary.WeekendDaySalary(day20, id) + "," +
                    ...
                    "[24]=" + day24 + ",[24DailiSalary]=" + salary.WorkDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + salary.WorkDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + salary.WeekendDaySalary(day26, id) + "," +
                    "[27]=" + day27 + ",[27DailiSalary]=" + salary. WeekendDaySalary(day27, id) + ",[28]=" + day28 + ",[28DailiSalary]=" + salary.WorkDaySalary(day28, id) + ",[29]=" + day29 + ",[29DailiSalary]=" + salary.WorkDaySalary(day29, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE August_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
