...
namespace PayrollTrackingApp1
{
    public partial class August : Form
    {
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            dBEntities3.August_2023.ToList();
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.August_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.August_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.August_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE August_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WorkDaySalary(day2, id) + "," +
                    "[3]=" + day3 + ",[3DailiSalary]=" + WorkDaySalary(day3, id) + ",[4]=" + day4 + ",[4DailiSalary]=" + WorkDaySalary(day4, id) + ",[5]=" + day5 + ",[5DailiSalary]=" +WeekendDaySalary(day5, id) + "," +
                    "[6]=" + day6 + ",[6DailiSalary]=" + WeekendDaySalary(day6, id) + ",[7DailiSalary]=" + WorkDaySalary(day7, id) + ",[8DailiSalary]=" + WorkDaySalary(day8, id) + "," +
                    ...
                    "[12]=" + day12 + ",[12DailiSalary]=" + WeekendDaySalary(day12, id) + ",[13]=" + day13 + ",[13DailiSalary]=" + WeekendDaySalary(day13, id) + ",[14]=" + day14 + ",[14DailiSalary]=" + WorkDaySalary(day14, id) + "," +
                    ...
                    "[18]=" + day18 + ",[18DailiSalary]=" + WorkDaySalary(day18, id) + ",[19]=" + day19 + ",[19DailiSalary]=" + WeekendDaySalary(day19, id) + ",[20]=" + day20 + ",[20DailiSalary]=" + WeekendDaySalary(day20, id) + "," +
                    ...
                    "[24]=" + day24 + ",[24DailiSalary]=" + WorkDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + WorkDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + WeekendDaySalary(day26, id) + "," +
                    "[27]=" + day27 + ",[27DailiSalary]=" + WeekendDaySalary(day27, id) + ",[28]=" + day28 + ",[28DailiSalary]=" + WorkDaySalary(day28, id) + ",[29]=" + day29 + ",[29DailiSalary]=" + WorkDaySalary(day29, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE August_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
