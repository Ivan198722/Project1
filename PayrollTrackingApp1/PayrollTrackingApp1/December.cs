...
{
    public partial class December : Form
    {
        ...
        private void December_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "payrollTrackingDBDataSet17.December_2023". При необходимости она может быть перемещена или удалена.
            this.december_2023TableAdapter.Fill(this.payrollTrackingDBDataSet17.December_2023);
        ...
        class Salary : SalaryCalculator
        {
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.December_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = from month in _dbEntities.December_2023
                            where month.Id == id
                            select new
                            {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE Decemer_2023 SET [1]=" + day1 + ",[1DailiSalary]=" +salary.WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" +salary.WeekendDaySalary(day2, id) + "," +
                    ...
                    "[9]=" + day9 + ",[9DailiSalary]=" + salary.WeekendDaySalary(day9, id) + ",[10]=" + day10 + ",[10DailiSalary]=" + salary.WeekendDaySalary(day10, id) + ",[11]=" + day11 + ",[11DailiSalary]=" + salary.WorkDaySalary(day11, id) + "," +
                    ...
                    "[15]=" + day15 + ",[15DailiSalary]=" + salary.WorkDaySalary(day15, id) + ",[16]=" + day16 + ",[16DailiSalary]=" + salary.WeekendDaySalary(day16, id) + ",[17]=" + day17 + ",[17DailiSalary]=" + salary.WeekendDaySalary(day17, id) + "," +
                    ...
                    "[21]=" + day21 + ",[21DailiSalary]=" + salary.WorkDaySalary(day21, id) + ",[22]=" + day22 + ",[22DailiSalary]=" + salary.WorkDaySalary(day22, id) + ",[23]=" + day23 + ",[23DailiSalary]=" + salary.WeekendDaySalary(day23, id) + "," +
                    "[24]=" + day24 + ",[24DailiSalary]=" + salary.WeekendDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + salary.WeekendDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + salary.WeekendDaySalary(day26, id) + "," +
                    ...
                    "[30]=" + day30 + ",[30DailiSalary]=" + salary.WeekendDaySalary(day30, id) + ",[31]=" + day31 + ",[31DailiSalary]=" + salary.WeekendDaySalary(day31, id) + " WHERE Id = " + id;
            ...
            try
            {
                string query1 = "UPDATE December_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
