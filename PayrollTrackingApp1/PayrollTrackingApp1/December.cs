...
namespace PayrollTrackingApp1
{
    public partial class December : Form
    {
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            dBEntities3.December_2023.ToList();
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.December_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.December_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.December_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE Decemer_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WeekendDaySalary(day2, id) + "," +
                    "[3]=" + day3 + ",[3DailiSalary]=" + WeekendDaySalary(day3, id) + ",[4]=" + day4 + ",[4DailiSalary]=" + WorkDaySalary(day4, id) + ",[5]=" + day5 + ",[5DailiSalary]=" +WorkDaySalary(day5, id) + "," +
                    "[6]=" + day6 + ",[6DailiSalary]=" + WorkDaySalary(day6, id) + ",[7DailiSalary]=" + WorkDaySalary(day7, id) + ",[8DailiSalary]=" + WorkDaySalary(day8, id) + "," +
                    "[9]=" + day9 + ",[9DailiSalary]=" + WeekendDaySalary(day9, id) + ",[10]=" + day10 + ",[10DailiSalary]=" + WeekendDaySalary(day10, id) + ",[11]=" + day11 + ",[11DailiSalary]=" + WorkDaySalary(day11, id) + "," +
                    ...
                    "[15]=" + day15 + ",[15DailiSalary]=" + WorkDaySalary(day15, id) + ",[16]=" + day16 + ",[16DailiSalary]=" + WeekendDaySalary(day16, id) + ",[17]=" + day17 + ",[17DailiSalary]=" + WeekendDaySalary(day17, id) + "," +
                    ...
                    "[21]=" + day21 + ",[21DailiSalary]=" + WorkDaySalary(day21, id) + ",[22]=" + day22 + ",[22DailiSalary]=" + WorkDaySalary(day22, id) + ",[23]=" + day23 + ",[23DailiSalary]=" + WeekendDaySalary(day23, id) + "," +
                    "[24]=" + day24 + ",[24DailiSalary]=" + WeekendDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + WeekendDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + WeekendDaySalary(day26, id) + "," +
                    ...
                    "[30]=" + day30 + ",[30DailiSalary]=" + WeekendDaySalary(day30, id) + ",[31]=" + day31 + ",[31DailiSalary]=" + WeekendDaySalary(day31, id) + " WHERE Id = " + id;
            ...
            try
            {
                string query1 = "UPDATE December_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
