    ...
    public partial class September : Form
    {
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.September_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string WeekendDaySalary(string time, string IdPerson)
        {
            ...
            dBEntities3.September_2023.ToList();
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.September_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.September_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    string query = "UPDATE September_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WeekendDaySalary(day2, id) + "," +
                        ...
                        "[24]=" + day24 + ",[24DailiSalary]=" + WeekendDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + WorkDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + WorkDaySalary(day26, id) + "," +
                        ...
                        "[30]=" + day30 + ",[30DailiSalary]=" + WeekendDaySalary(day30, id) + " WHERE Id = " + id;
                ...
                try
                {
                    string query1 = "UPDATE September_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
