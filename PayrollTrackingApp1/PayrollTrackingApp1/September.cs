...
namespace PayrollTrackingApp1
{
    ...
    public partial class September : Form
    {
        ...
        private void September_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "payrollTrackingDBDataSet14.September_2023". При необходимости она может быть перемещена или удалена.
            this.september_2023TableAdapter.Fill(this.payrollTrackingDBDataSet14.September_2023);
        ...
        class Salary : SalaryCalculator
        {
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.September_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = from month in _dbEntities.September_2023
                            where month.Id == id
                            select new
                            {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    string query = "UPDATE September_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + salary.WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" +salary.WeekendDaySalary(day2, id) + "," +
                        ...
                        "[24]=" + day24 + ",[24DailiSalary]=" + salary.WeekendDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + salary.WorkDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + salary.WorkDaySalary(day26, id) + "," +
                        ...
                        "[30]=" + day30 + ",[30DailiSalary]=" + salary.WeekendDaySalary(day30, id) + " WHERE Id = " + id;
                ...
                try
                {
                    string query1 = "UPDATE September_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
