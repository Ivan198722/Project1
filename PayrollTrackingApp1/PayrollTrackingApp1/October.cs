...
namespace PayrollTrackingApp1
{
    public partial class October : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "payrollTrackingDBDataSet15.October_2023". При необходимости она может быть перемещена или удалена.
            this.october_2023TableAdapter.Fill(this.payrollTrackingDBDataSet15.October_2023);
        ...
        class Salary : SalaryCalculator
        {
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.October_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = from month in _dbEntities.October_2023
                            where month.Id == id
                            select new
                            {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE October_2023 SET [1]=" + day1 + ",[1DailiSalary]=" +salary.WeekendDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" +salary.WorkDaySalary(day2, id) + "," +
                    ...
                    "[6]=" + day6 + ",[6DailiSalary]=" + salary.WorkDaySalary(day6, id) + ",[7]="+day7+",[7DailiSalary]=" + salary.WeekendDaySalary(day7, id) + ",[8]="+day8+",[8DailiSalary]=" + salary.WeekendDaySalary(day8, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE October_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
