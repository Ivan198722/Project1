...
namespace PayrollTrackingApp1
{
    public partial class October : Form
    {
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            dBEntities3.October_2023.ToList();
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.October_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.October_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.October_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE October_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WeekendDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WorkDaySalary(day2, id) + "," +
                    ...
                    "[6]=" + day6 + ",[6DailiSalary]=" + WorkDaySalary(day6, id) + ",[7DailiSalary]=" + WeekendDaySalary(day7, id) + ",[8DailiSalary]=" + WeekendDaySalary(day8, id) + "," +
                    ...
                    "[12]=" + day12 + ",[12DailiSalary]=" + WorkDaySalary(day12, id) + ",[13]=" + day13 + ",[13DailiSalary]=" + WorkDaySalary(day13, id) + ",[14]=" + day14 + ",[14DailiSalary]=" + WeekendDaySalary(day14, id) + "," +
                    "[15]=" + day15 + ",[15DailiSalary]=" + WeekendDaySalary(day15, id) + ",[16]=" + day16 + ",[16DailiSalary]=" + WorkDaySalary(day16, id) + ",[17]=" + day17 + ",[17DailiSalary]=" + WorkDaySalary(day17, id) + "," +
                    ...
                    "[21]=" + day21 + ",[21DailiSalary]=" + WeekendDaySalary(day21, id) + ",[22]=" + day22 + ",[22DailiSalary]=" + WeekendDaySalary(day22, id) + ",[23]=" + day23 + ",[23DailiSalary]=" + WorkDaySalary(day23, id) + "," +
                    ...
                    "[27]=" + day27 + ",[27DailiSalary]=" + WorkDaySalary(day27, id) + ",[28]=" + day28 + ",[28DailiSalary]=" + WeekendDaySalary(day28, id) + ",[29]=" + day29 + ",[29DailiSalary]=" + WeekendDaySalary(day29, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE October_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
