    ...
    public partial class June : Form
    {
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.June_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.June_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.June_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE June_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WorkDaySalary(day2, id) + "," +
                    "[3]=" + day3 + ",[3DailiSalary]=" + WeekendDaySalary(day3, id) + ",[4]=" + day4 + ",[4DailiSalary]=" + WeekendDaySalary(day4, id) + ",[5]=" + day5 + ",[5DailiSalary]=" + WorkDaySalary(day5, id) + "," +
                    "[6]=" + day6 + ",[6DailiSalary]=" + WorkDaySalary(day6, id) + ",[7DailiSalary]=" + WorkDaySalary(day7, id) + ",[8DailiSalary]=" + WeekendDaySalary(day8, id) + "," +
                    "[9]=" + day9 + ",[9DailiSalary]=" + WorkDaySalary(day9, id) + ",[10]=" + day10 + ",[10DailiSalary]=" + WeekendDaySalary(day10, id) + ",[11]=" + day11 + ",[11DailiSalary]=" + WeekendDaySalary(day11, id) + "," +
                    ...
                    "[15]=" + day15 + ",[15DailiSalary]=" + WorkDaySalary(day15, id) + ",[16]=" + day16 + ",[16DailiSalary]=" + WorkDaySalary(day16, id) + ",[17]=" + day17 + ",[17DailiSalary]=" + WeekendDaySalary(day17, id) + "," +
                    "[18]=" + day18 + ",[18DailiSalary]=" + WeekendDaySalary(day18, id) + ",[19]=" + day19 + ",[19DailiSalary]=" + WorkDaySalary(day19, id) + ",[20]=" + day20 + ",[20DailiSalary]=" + WorkDaySalary(day20, id) + "," +
                    ...
                    "[24]=" + day24 + ",[24DailiSalary]=" + WeekendDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + WeekendDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + WorkDaySalary(day26, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE June_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
