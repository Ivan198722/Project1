...
{
    public partial class June : Form
    {
        ...
        private void June_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "payrollTrackingDBDataSet8.June_2023". При необходимости она может быть перемещена или удалена.
            this.june_2023TableAdapter.Fill(this.payrollTrackingDBDataSet8.June_2023);
        ...
        class Salary : SalaryCalculator
        {
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.June_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = from month in _dbEntities.June_2023
                            where month.Id == id
                            select new
                            {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE June_2023 SET [1]=" + day1 + ",[1DailiSalary]=" +salary.WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + salary.WorkDaySalary(day2, id) + "," +
                    "[3]=" + day3 + ",[3DailiSalary]=" +salary.WeekendDaySalary(day3, id) + ",[4]=" + day4 + ",[4DailiSalary]=" + salary.WeekendDaySalary(day4, id) + ",[5]=" + day5 + ",[5DailiSalary]=" + salary.WorkDaySalary(day5, id) + "," +
                    ...
                    "[9]=" + day9 + ",[9DailiSalary]=" + salary.WorkDaySalary(day9, id) + ",[10]=" + day10 + ",[10DailiSalary]=" + salary.WeekendDaySalary(day10, id) + ",[11]=" + day11 + ",[11DailiSalary]=" + salary.WeekendDaySalary(day11, id) + "," +
                    ...
                    "[15]=" + day15 + ",[15DailiSalary]=" + salary.WorkDaySalary(day15, id) + ",[16]=" + day16 + ",[16DailiSalary]=" + salary.WorkDaySalary(day16, id) + ",[17]=" + day17 + ",[17DailiSalary]=" + salary.WeekendDaySalary(day17, id) + "," +
                    "[18]=" + day18 + ",[18DailiSalary]=" + salary.WeekendDaySalary(day18, id) + ",[19]=" + day19 + ",[19DailiSalary]=" + salary.WorkDaySalary(day19, id) + ",[20]=" + day20 + ",[20DailiSalary]=" + salary.WorkDaySalary(day20, id) + "," +
                    ...
                    "[24]=" + day24 + ",[24DailiSalary]=" + salary.WeekendDaySalary(day24, id) + ",[25]=" + day25 + ",[25DailiSalary]=" + salary.WeekendDaySalary(day25, id) + ",[26]=" + day26 + ",[26DailiSalary]=" + salary.WorkDaySalary(day26, id) + "," +
                    ...
                    "[30]=" + day30 + ",[30DailiSalary]=" + salary.WorkDaySalary(day30, id) + " WHERE Id = " + id;
            ...
            try
            {
                string query1 = "UPDATE June_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
