    ...
    public partial class November : Form
    {
        ...
        class Salary : SalaryCalculator
        {
            internal override IQueryable<object> GetSalaryData(int id)
            {
                var query = from pos in _dbEntities.PositionsAndPays
                            ...
                            join month in _dbEntities.November_2023 on emp.Id equals month.IdEmployee
                            where month.Id == id
            ...
            internal override IQueryable<object> GetSalaryData_Month(int id)
            {
                ...
                var query = from month in _dbEntities.November_2023
                            where month.Id == id
                            select new
                            {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE Noveber_2023 SET [1]=" + day1 + ",[1DailiSalary]=" +salary.WeekendDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" +salary.WorkDaySalary(day2, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE November_2023 SET MonthliSalary=" + salary.MonthSalary(id) + " where Id=" + id;
