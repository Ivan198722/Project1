...
namespace PayrollTrackingApp1
{
    public partial class March : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "payrollTrackingDBDataSet13.March_2023". При необходимости она может быть перемещена или удалена.
        ...
        private string WorkDaySalary(string time, string IdPerson)
        {
            ...
            var query = from pos in dBEntities3.PositionsAndPays
                        ...
                        join month in dBEntities3.March_2023 on emp.Id equals month.IdEmployee
                        where month.Id == id
        ...
        private string MonthSalary(string IdPerson)
        {
            ...
            dBEntities3.March_2023.ToList();
            int id = Int32.Parse(IdPerson);
            var query = from month in dBEntities3.March_2023
                        where month.Id == id
                        select new
                        {
        ...
        private void add_button_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "UPDATE March_2023 SET [1]=" + day1 + ",[1DailiSalary]=" + WorkDaySalary(day1, id) + ",[2]=" + day2 + ",[2DailiSalary]=" + WorkDaySalary(day2, id) + "," +
            ...
            try
            {
                string query1 = "UPDATE March_2023 SET MonthliSalary=" + MonthSalary(id) + " where Id=" + id;
